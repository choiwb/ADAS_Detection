...
def process_video(image):
    ...
    if position > 640:
        cv2.putText(result,'Distance of left side : {:.2f}(m)'.format(distance_from_center), (100,80),
                 fontFace = 16, fontScale = 2, color=(255,255,255), thickness = 2)
    else:
        cv2.putText(result, 'Distance of right side : {:.2f}(m)'.format(distance_from_center), (100,80),
                 fontFace = 16, fontScale = 2, color=(255,255,255), thickness = 2)
...
if __name__ == '__main__':
    ...
    parser.add_argument('output', type=str,
                        ...
                        default = 'car_output.mp4')
                        # default = 'car2_output.mp4')
                        # default = 'car3_output.mp4')

    '''
        python main.py video car.mp4 car_output.mp4
        python main.py video car2.mp4 car2_output.mp4
        python main.py video car3.mp4 car3_output.mp4
    '''
    ...
    SSD_GRAPH_FILE = 'ssd_inception_v2_coco_2017_11_17/frozen_inference_graph.pb'
